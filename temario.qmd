...
tibble::tibble(Tema = c("Instalar R",
                        ...
                        "Datos Espaciales"),
               Instructor = c(rep("Felipe Dzul-Manzanilla, Jonathan Mendoza-Cruz & Arath Martínez-Flores", times = 9))) |>
...
-   [Instalación de Paquetes](https://jovial-sunburst-ee3a1b.netlify.app/talks/pkg_installation/#/), [dengueverse](https://calm-hummingbird-41cb33.netlify.app/talks/dengueverse/#/dengueverse), [Datos Espaciales](https://calm-hummingbird-41cb33.netlify.app/talks/spatial_data/#/)
...
### Módulo VI. Dashboard de la transmisión activa

```{r temario_modulo_VI, echo=FALSE}
tibble::tibble(Tema = c("Creación de un Dashboard",
                        "Git & Github",
                        "Netlify"),
               Instructor = c(rep("Felipe Antonio Dzul Manzanilla", 
                                  times = 3))) |>
